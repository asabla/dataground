**This is still very much a work in process. The goal is to find the breaking point of using ChatGPT Work (only) to build, validate and complete a Databricks equivalent. It will be using [Openshell](https://github.com/NVIDIA/OpenShell) for sandboxing, [Rosetta](https://github.com/asabla/rosetta) (a [Cedar](https://docs.cedarpolicy.com/) policy compilation system, with support for Openshell, Codex, Opencode, Hermes etc).**

Everything you see after this separator is generated by ChatGPT Work.
