...
func validActionResource(action Action, resourceType ResourceType) bool {
	...
	case ReadServiceRevision, PublishServiceRevision, RetireServiceRevision:
		return resourceType == ServiceRevision
	case ReadInvocation, CancelInvocation, ReadInvocationEvents, ListInvocationApprovals, ListInvocationQuestions:
