...
const (
	...
	ReadServiceRevision       Action = "readServiceRevision"
	ReadServiceRevisionAudit  Action = "readServiceRevisionAudit"
	ReadInvocationAudit       Action = "readInvocationAudit"
	PublishServiceRevision    Action = "publishServiceRevision"
	RetireServiceRevision     Action = "retireServiceRevision"
	ListServiceAliases        Action = "listServiceAliases"
	ReadServiceAlias          Action = "readServiceAlias"
	AssignServiceAlias        Action = "assignServiceAlias"
	WithdrawServiceAlias      Action = "withdrawServiceAlias"
	InvokeAgentService        Action = "invokeAgentService"
	ListInvocationQuestions   Action = "listInvocationQuestions"
	ListInvocationApprovals   Action = "listInvocationApprovals"
	...
	ReadInvocationQuestion    Action = "readInvocationQuestion"
	AnswerInvocationQuestion  Action = "answerInvocationQuestion"
...
const (
	...
	InvocationQuestion ResourceType = "DataGround::InvocationQuestion"
...
func validActionResource(action Action, resourceType ResourceType) bool {
	...
	case CreateServiceRevision, ListServiceRevisions, ListServiceAliases, ReadServiceAlias, AssignServiceAlias, WithdrawServiceAlias, InvokeAgentService, ListInvocations:
		return resourceType == AgentService
	case ReadServiceRevisionAudit, ReadServiceRevision, PublishServiceRevision, RetireServiceRevision:
		return resourceType == ServiceRevision
	case ReadInvocationAudit, ReadInvocation, CancelInvocation, ReadInvocationEvents, ListInvocationApprovals, ListInvocationQuestions:
		return resourceType == Invocation
	case ReadInvocationQuestion, AnswerInvocationQuestion:
		return resourceType == InvocationQuestion
