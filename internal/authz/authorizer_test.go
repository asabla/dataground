...
func TestDevelopmentCedarAuthorizerBindsPrincipalDomainAndClosedActions(t *testing.T) {
	...
	requests := []authz.Request{
		request(principal, authz.ListInvocationQuestions, authz.Invocation, "inv_00000000000000000001"),
		...
		request(principal, authz.ReadServiceRevisionAudit, authz.ServiceRevision, "rev_00000000000000000001"),
		request(principal, authz.ReadInvocationAudit, authz.Invocation, "inv_00000000000000000001"),
		request(principal, authz.ReadServiceRevision, authz.ServiceRevision, "rev_00000000000000000001"),
		...
		request(principal, authz.ListServiceAliases, authz.AgentService, "svc_00000000000000000001"),
		...
		request(principal, authz.WithdrawServiceAlias, authz.AgentService, "svc_00000000000000000001"),
