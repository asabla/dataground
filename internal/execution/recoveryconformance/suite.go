...
const (
	...
	PhaseFailoverCommitLoss      Phase = "failover-commit-loss"
	PhaseFailoverCommitRecover   Phase = "failover-commit-recover"
	PhaseFailoverRejoinObserve   Phase = "failover-rejoin-observe"
)
