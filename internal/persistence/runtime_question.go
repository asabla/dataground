...
func lockRuntimeQuestionAttempt(ctx context.Context, tx pgx.Tx, claim OperationClaim, effect EffectRecord) error {
	var now time.Time
...
func questionLockUnavailable(err error) bool {
