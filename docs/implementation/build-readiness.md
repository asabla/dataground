...
| Reference S3 and Iceberg implementations | Evidence spike required | The enforcement-object S3 REST adapter exists; select and certify one self-hosted implementation of each storage contract |
